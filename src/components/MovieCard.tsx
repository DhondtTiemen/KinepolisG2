...
export default () => {
  ...
  const fetchData = () => {
    ...
    fetch(`https://kinepolisweb-programmation-int.kinepolis.com/api//Programmation/BE/NL/${currentDate}/${currentLocation}/WWW`)
  ...
  return (
    movie && movie.sessions.map((movieSession: RootObject) => (
      <div className="bg-alpha-x w-96 h-48 rounded-2xl overflow-hidden">
        <div className="flex h-[62%]">
          ...
          <div className="w-2/4 mt-4">
            <MovieTimeInfo movieTime={movieSession.showtime} movieHall={movieSession.hall} cosy={movieSession.hasCosySeating} special={movieSession.hasSpecialSeating}/>
          </div>
